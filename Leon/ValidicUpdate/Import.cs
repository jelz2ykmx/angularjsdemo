...
namespace ValidicUpdate
{
    class Import
    {
        ...
        async Task GetValidicData(int validicObject, Ids id, DateTime startDate, DateTime nowDate, String next)
        {
            ...
            else
            {
                ...
                cadena = "/v1/organizations/" + idValidic + "/" +
                        ...
                        "&start_date=" + sini.ToString() + "&end_date=" + send.ToString() + "&show_original_source=1";
            }
        ...
        async Task InsertValidicMobile(SqlConnection connection1, int validicObject, JToken o, int x)
        {
