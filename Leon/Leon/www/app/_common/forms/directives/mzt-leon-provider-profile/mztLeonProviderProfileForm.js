...
app.controller('mztLeonProviderProfileCtrl', function ($scope, $window, $element, DTOptionsBuilder, DTColumnBuilder, $location, $rootScope, UserProviderFactory, apiServices, RegisterUserFactory, $interval) {
    var _state = {};
    var _city = {};
    var _indexLocation = {};
    var state;
    ...
    var backTop = function () {
        ...
        $location.path('/form/mzt-leon-provider-profile');
    }
...
app.directive('mztLeonProviderProfileForm', function () {
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'app/_common/forms/directives/mzt-leon-provider-profile/mzt-leon-provider-profile-form.tpl.html',
        ...
        controller: 'mztLeonProviderProfileCtrl as datatables'
    }
