...
app.controller('mztLeonQuestionsCtrl', function ($scope, $window, $element, $location, $rootScope, $interval, queryQuestionFactory, questionFactory, apiServices,
    queryQuestionTempFactory, $compile, $timeout) {
    ...
    //alert($rootScope.phoneType);
    if ($rootScope.phoneType == 5) {
        $('.fix-counting').css('right', '288px');
    }
    ...
    */
    ...
    if ($rootScope.phoneType == 0) {  //IPHONE 6 and Iphone 6s plus
        $element.find("#botonSubmit").css("left", "41.7%");
    }
    ...
    $scope.providerRole = $rootScope.providerRole;
    ...
    var progressBar = function (elemName, startWidth, endWidth, label) {
        var valores = {
            width: 0,
            endWidth: 0
        };
    ...
    $scope.$watch('hidepoints', function () {
        if ($scope.hidepoints == false) {
            unblockScroll();
        } else {
            blockScroll();
        }
    ...
    //$scope.$watch('hideEmail', function () {
    //    if ($scope.hideAll == true && $scope.hideEmail == false) {
    //        unblockScroll();
    //    }
    //});
    ...
    var initUser = function () {
        ...
        if (pointsFlag != undefined && pointsFlag == "1") {
            ...
            $scope.lastname = dataPoints.last;
            ...
            odometer(dataPoints.avarage, sizeOdometer);
        }
        else 
        {
    ...
    var init = function () {
        ...
        var pointsFlag = localStorage.getItem("pointsFlag");
        if (pointsFlag == "1") {
        ...
        if (pointsFlag == "1") {
            ...
            dashboardFlag = queryQuestionFactory.dashboard;
            questionFactory.idform = queryQuestionFactory.id;
    ...
    var fillData = function (data) {
        ...
        $scope.avarageData = data.avarage;
    ...
    var odometer = function (avarage, size) {
        ...
        $('.chart').easyPieChart({
            ...
            onStop: function (from, to) {
                $scope.scoreAnimated = false;
                progressBar('bar-fitness', 0, FitnessPoints, 'percentile-fitness');
                progressBar('bar-biometrics', 0, BiodataPoints, 'percentile-biometrics');
                progressBar('bar-mobility', 0, MobilityPoints, 'percentile-mobility');
                progressBar('bar-life', 0, LifestylePoints, 'percentile-life');
    ...
    $scope.gohowold = function (howold) {
        ...
        var idOldAge = $scope.selectedAge.id;
        ...
        putValuesByAge(idOldAge, $scope.selectedAge.id);
    ...
    $scope.next = function () {
        ...
        if (countQ > countSubmit) {
            ...
            {
                if (countQ != 11 && countQ != 29 && countQ != 30 && countQ != 31 && countQ != 32 && countQ != 33) {
                    $scope.hideNext = true;
                }
        ...
        switch (countQ) {
            case 2:
                if (opt1) {
                    ...
                    $timeout(function () { $scope.hideOld = opt2; }, 100);
                }
                else {
                    $scope.hideOld = opt2; 
                    $timeout(function () { $scope.hideGender = opt1; }, 100);
                }
                break;
            case 3:
                if (opt1) {
                    $scope.hideOld = opt1;
                    $timeout(function () { $scope.hideHeight = opt2; }, 100);
                }
                else {
                    $scope.hideHeight = opt2;
                    $timeout(function () { $scope.hideOld = opt1; }, 100);
                }
                break;
            case 4:
                if (opt1) {
                    $scope.hideHeight = opt1;
                    $timeout(function () { $scope.hideWeight = opt2; }, 100);
                }
                else {
                    $scope.hideWeight = opt2;
                    $timeout(function () { $scope.hideHeight = opt1; }, 100);
                }
                break;
            case 5:
                if (opt1) {
                    $scope.hideWeight = opt1;
                    $timeout(function () { $scope.hideCar = opt2; }, 100);
                }
                else {
                    $scope.hideCar = opt2;
                    $timeout(function () { $scope.hideWeight = opt1; }, 100);
                }
                break;
            case 6:
                if (opt1) {
                    $scope.hideCar = opt1;
                    $timeout(function () { $scope.hideChe = opt2; }, 100);
                }
                else {
                    $scope.hideChe = opt2;
                    $timeout(function () { $scope.hideCar = opt1; }, 100);
                }
                break;
            case 7:
                if (opt1) {
                    $scope.hideChe = opt1;
                    $timeout(function () { $scope.hideFat = opt2; }, 100);
                }
                else {
                    $scope.hideFat = opt2;
                    $timeout(function () { $scope.hideChe = opt1; }, 100);
                }
                break;
            case 8:
                if (opt1) {
                    $scope.hideFat = opt1;
                    $timeout(function () { $scope.hideMot = opt2; }, 100);
                }
                else {
                    $scope.hideMot = opt2;
                    $timeout(function () { $scope.hideFat = opt1; }, 100);
                }
                break;
            case 9:
                if (opt1) {
                    $scope.hideMot = opt1;
                    $timeout(function () { $scope.hideDia = opt2; }, 100);
                }
                else {
                    $scope.hideDia = opt2;
                    $timeout(function () { $scope.hideMot = opt1; }, 100);
                }
                break;
            case 10:
                if (opt1) {
                    $scope.hideDia = opt1;
                    $timeout(function () { $scope.hideMod = opt2; }, 100);
                }
                else {
                    $scope.hideMod = opt2;
                    $timeout(function () { $scope.hideDia = opt1; }, 100);
                }
                $scope.hideNext = false;
                break;
            case 11:
                if (opt1) {
                    $scope.hideMod = opt1;
                    $timeout(function () { $scope.hideSit = opt2; }, 100);
                }
                else {
                    $scope.hideSit = opt2;
                    $timeout(function () { $scope.hideMod = opt1; }, 100);
                }
                break;
            case 12:
                if (opt1) {
                    $scope.hideSit = opt1;
                    $timeout(function () { $scope.hideSmo = opt2; }, 100);
                }
                else {
                    $scope.hideSmo = opt2;
                    $timeout(function () { $scope.hideSit = opt1; }, 100);
                }
                break;
        }
        ...
        if ((countQ == 13 || countQ == 14) && $scope.selectSmo.id > 1) {
            ...
            switch (countQ) {
                case 14:
                    if (opt1) {
                        $scope.hideSmo = opt1;
                        $timeout(function () { $scope.hideAlc = opt2; }, 100);
                    }
                    else {
                        $scope.hideAlc = opt2;
                        $timeout(function () { $scope.hideSmo = opt1; }, 100);
                    }
                    break;
            }
            if (opt2) {
            ...
            switch (countQ) {
                case 13:
                    if (opt1) {
                        $scope.hideSmo = opt1;
                        $timeout(function () { $scope.hideSmokes = opt2; }, 100);
                    }
                    else {
                ...
                case 14:
                    if (opt1) {
                        ...
                        $scope.hideAlc = opt2;
                        $timeout(function () { $scope.hideSmokes = opt1; }, 100);
                    }
                    break;
            }
        ...
        if (countQ >= 15) {
            switch (countQ) {
                case 15:
                    if (opt1) {
                        $scope.hideAlc = opt1;
                        $timeout(function () { $scope.hideAnt = opt2; }, 100);
                    }
                    else {
                        $scope.hideAnt = opt2;
                        $timeout(function () { $scope.hideAlc = opt1; }, 100);
                    }
                    break;
                case 16:
                    if (opt1) {
                        $scope.hideAnt = opt1;
                        $timeout(function () { $scope.hideRated = opt2; }, 100);
                    }
                    else {
                        $scope.hideRated = opt2;
                        $timeout(function () { $scope.hideAnt = opt1; }, 100);
                    }
                    break;
                case 17:
                    if (opt1) {
                        $scope.hideRated = opt1;
                        $timeout(function () { $scope.hideLife = opt2; }, 100);
                    }
                    else {
                        $scope.hideLife = opt2;
                        $timeout(function () { $scope.hideRated = opt1; }, 100);
                    }
                    break;
                case 18:
                    if (opt1) {
                        $scope.hideLife = opt1;
                        $timeout(function () { $scope.hideOrg = opt2; }, 100);
                    }
                    else {
                        $scope.hideOrg = opt2;
                        $timeout(function () { $scope.hideLife = opt1; }, 100);
                    }
                    break;
                case 19:
                    if (opt1) {
                        $scope.hideOrg = opt1;
                        $timeout(function () { $scope.hidePlaning = opt2; }, 100);
                    }
                    else {
                        $scope.hidePlaning = opt2;
                        $timeout(function () { $scope.hideOrg = opt1; }, 100);
                    }
                    break;
                case 20:
                    if (opt1) {
                        $scope.hidePlaning = opt1;
                        $timeout(function () { $scope.hideSys = opt2; }, 100);
                    }
                    else {
                        $scope.hideSys = opt2;
                        $timeout(function () { $scope.hidePlaning = opt1; }, 100);
                    }
                    break;
            }
        }
    ...
    var HideShowMen = function (opt1, opt2) {
        switch (countQ) {
            case 21:
                if (opt1) {
                    $scope.hideSys = opt1;
                    $timeout(function () { $scope.disablegendermenWai = opt2; }, 100);
                }
                else {
                    $scope.disablegendermenWai = opt2;
                    $timeout(function () { $scope.hideSys = opt1; }, 100);
                }
                break;
            case 22:
                if (opt1) {
                    $scope.disablegendermenWai = opt1;
                    $timeout(function () { $scope.hideDee = opt2; }, 100);
                }
                else {
                    $scope.hideDee = opt2;
                    $timeout(function () { $scope.disablegendermenWai = opt1; }, 100);
                }
                break;
            case 23:
                if (opt1) {
                    $scope.hideDee = opt1;
                    $timeout(function () { $scope.hideAct = opt2; }, 100);
                }
                else {
                    $scope.hideAct = opt2;
                    $timeout(function () { $scope.hideDee = opt1; }, 100);
                }
                break;
            case 24:
                if (opt1) {
                    $scope.hideAct = opt1;
                    $timeout(function () { $scope.hideMob = opt2; }, 100);
                }
                else {
                    $scope.hideMob = opt2;
                    $timeout(function () { $scope.hideAct = opt1; }, 100);
                }
                break;
            case 25:
                if (opt1) {
                    $scope.hideMob = opt1;
                    $timeout(function () { $scope.hideSho = opt2; }, 100);
                }
                else {
                    $scope.hideSho = opt2;
                    $timeout(function () { $scope.hideMob = opt1; }, 100);
                }
                break;
            case 26:
                if (opt1) {
                    $scope.hideSho = opt1;
                    $timeout(function () { $scope.hideSpi = opt2; }, 100);
                }
                else {
                    $scope.hideSpi = opt2;
                    $timeout(function () { $scope.hideSho = opt1; }, 100);
                }
                break;
            case 27:
                if (opt1) {
                    $scope.hideSpi = opt1;
                    $timeout(function () { $scope.hideSpiExt = opt2; }, 100);
                }
                else {
                    $scope.hideSpiExt = opt2;
                    $timeout(function () { $scope.hideSpi = opt1; }, 100);
                }
                break;
            case 28:
                if (opt1) {
                    $scope.hideSpiExt = opt1;
                    $timeout(function () { $scope.disablegendermenSid = opt2; }, 100);
                }
                else {
                    $scope.disablegendermenSid = opt2;
                    $timeout(function () { $scope.hideSpiExt = opt1; }, 100);
                }
                $scope.hideNext = false;
                break;
            case 29:
                if (opt1) {
                    ...
                    $timeout(function () { $scope.disablegendermenSid = opt1; }, 100);
                }
                MBCM(opt2);
                $scope.hideNext = false;
                break;
    ...
    var HideShowWoMen = function (opt1, opt2) {
        switch (countQ) {
            case 21:
                if (opt1) {
                    $scope.hideSys = opt1;
                    $timeout(function () { $scope.disablegenderwomenWai = opt2; }, 100);
                }
                else {
            ...
            case 22:
                if (opt1) {
                    ...
                    $scope.hideDee = opt2;
                    $timeout(function () { $scope.disablegenderwomenWai = opt1; }, 100);
                }
                break;
            case 23:
                if (opt1) {
            ...
            case 28:
                if (opt1) {
                    $scope.hideSpiExt = opt1;
                    $timeout(function () { $scope.disablegenderwomenSid = opt2; }, 100);
                }
                else {
            ...
            case 29:
                if (opt1) {
                    ...
                    $timeout(function () { $scope.disablegenderwomenSid = opt1; }, 100);
                }
                MBCW(opt2);
                break;
                $scope.hideNext = false;
            case 30:
                ...
                if (opt2) {
                    ...
                    $timeout(function () { $scope.disablegenderwomenMod = opt2 }, 100);
                }
                break;
            case 31:
                if (opt1) {
                    ...
                    $timeout(function () { $scope.disablegenderwomenMod = opt1; }, 100);
                }
                genderWoMan(opt2);
                $scope.hideNext = false;
                break;
    ...
    $scope.gonumMBCOOWpwm1 = function (numMBCOOWpwm1) {
        ...
        if ($scope.selectedCooMen1.value > 25) {
            $scope.selectedCooMen1.value = 25;
        }
    ...
    $scope.gonumMBCOOWpwm2 = function (numMBCOOWpwm2) {
        ...
        if ($scope.selectedCooMen2.value > 25) {
            $scope.selectedCooMen2.value = 25;
        }
...
/*
    ...
    $scope.gonumMBCOOWpwm3 = function (numMBCOOWpwm3) {
        ...
        if ($scope.selectedCooMen3.value > 25) {
            $scope.selectedCooMen3.value = 25;
        }
    ...
    $scope.gonumMBCOOWpwm4 = function (numMBCOOWpwm4) {
        ...
        if ($scope.selectedCooMen4.value > 25) {
            $scope.selectedCooMen4.value = 25;
        }
/*
    ...
    $scope.gonumMBCOOWOpwm1 = function (numMBCOOWOpwm1) {
        ...
        if ($scope.selectedCW1.value > 25) {
            $scope.selectedCW1.value = 25;
        }
        /*
    ...
    $scope.gonumMBCOOWOpwm2 = function (numMBCOOWOpwm2) {
        ...
        if ($scope.selectedCW2.value > 25) {
            $scope.selectedCW2.value = 25;
        }
/*
    ...
    $scope.gonumMBCOOWOpwm3 = function (numMBCOOWOpwm3) {
        ...
        if ($scope.selectedCW3.value > 25) {
            $scope.selectedCW3.value = 25;
        }
    ...
    $scope.gonumMBCOOWOpwm4 = function (numMBCOOWOpwm4) {
        ...
        if ($scope.selectedCW4.value > 25) {
            $scope.selectedCW4.value = 25;
        }
...
/*
    ...
    var statusFields = function () {
        if ($rootScope.phoneDevice < 0 || flagreview) {
    ...
    var genderMan = function (opt) {
        ...
        if ($scope.selectedAge.id == 0) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendermen1 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendermen2 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendermen3 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendermen4 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id >= 7) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendermen5 = opt; }, 100);
            }
        }
    }
    ...
    var MBCM = function (opt) {
        if ($scope.selectedAge.id == 0) {
            if (opt) {
                ...
                $timeout(function () { $scope.disableMBCM1 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
            if (opt) {
                ...
                $timeout(function () { $scope.disableMBCM2 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
            if (opt) {
                ...
                $timeout(function () { $scope.disableMBCM3 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id >= 5) {
            if (opt) {
                ...
                $timeout(function () { $scope.disableMBCM4 = opt; }, 100);
            }
        }
    }
    ...
    var coomen = function (opt) {
        if ($scope.selectedAge.id == 0) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendercoomen1 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendercoomen2 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendercoomen3 = opt; }, 100);
            }
        }
        else if ($scope.selectedAge.id >= 5) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendercoomen4 = opt; }, 100);
            }
        }
        ...
        if ($scope.selectedPusWomenModified.id == 1) {
            ...
            if ($scope.selectedAge.id == 0) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegendermod1women = opt }, 100);
                }
            }
            else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegendermod2women = opt }, 100);
                }
            }
            else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegendermod3women = opt }, 100);
                }
            }
            else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegendermod4women = opt }, 100);
                }
            }
            else if ($scope.selectedAge.id >= 7) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegendermod5women = opt }, 100);
                }
            }
        }
        else {
            ...
            if ($scope.selectedAge.id == 0) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegender1women = opt }, 100);
                }
            }
            else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegender2women = opt }, 100);
                }
            }
            else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegender3women = opt }, 100);
                }
            }
            else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegender4women = opt }, 100);
                }
            }
            else if ($scope.selectedAge.id >= 7) {
                if (opt) {
                    ...
                    $timeout(function () { $scope.disablegender5women = opt }, 100);
                }
            }
        }
    }
    ...
    var MBCW = function (opt) {
        if ($scope.selectedAge.id == 0) {
            if (opt) {
                ...
                $timeout(function () { $scope.disableMBCW1 = opt }, 100);
            }
        }
        else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
            if (opt) {
                ...
                $timeout(function () { $scope.disableMBCW2 = opt }, 100);
            }
        }
        else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
            if (opt) {
                ...
                $timeout(function () { $scope.disableMBCW3 = opt }, 100);
            }
        }
        else if ($scope.selectedAge.id >= 5) {
            if (opt) {
                ...
                $timeout(function () { $scope.disableMBCW4 = opt }, 100);
            }
        }
    }
    ...
    var coowomen = function (opt) {
        if ($scope.selectedAge.id == 0) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendercoowomen1 = opt }, 100);
            }
        }
        else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendercoowomen2 = opt }, 100);
            }
        }
        else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendercoowomen3 = opt }, 100);
            }
        }
        else if ($scope.selectedAge.id >= 5) {
            if (opt) {
                ...
                $timeout(function () { $scope.disablegendercoowomen4 = opt }, 100);
            }
        }
    }
    ...
    var SaveInCookie = function () {
        ...
        questionFactory.min = $scope.min;
        questionFactory.max = $scope.max;

        if (!_.isUndefined(questionFactory.cityId)) {
            if (!_.isUndefined($scope.selectedLocation)) {
                questionFactory.cityId = $scope.selectedLocation.cityId;
            }
        } else {
            questionFactory.cityId = 0;
        }
    ...
    var doSave = function () {
        ...
        .then(function (data) {
            ...
            odometer(data.avarage, sizeOdometer);
    ...
    var showReview = function () {
        ...
        $scope.hideAlc = false;
        $scope.hideAnt = false;
        $scope.hideRated = false;
        $scope.hideLife = false;
        $scope.hideOrg = false;
        $scope.hidePlaning = false;
        $scope.hideSys = false;
        $scope.hideDialostic = false;
    ...
    var backTop = function () {
        ...
        $interval.cancel(stopTime);
        $("#dialog").dialog("close");
        if (dashboardFlag == undefined || dashboardFlag == "0") {
    ...
    $scope.goradioScoreQ = function (value) {
        ...
        if (value == 0) {
            ...
            odometer( $scope.avarageData, sizeOdometer);
    ...
    $rootScope.statusDelete = function () {
        ...
        var model = { parameters: arreglo };
        apiServices.getData(model, 'api/Questions/StatusAssessment')
        .then(function (data) {
            $("#dialog").dialog("close");
            stopTime = $interval(backTop, $rootScope.dialogTimer);
        }, function (error) {
    ...
    var putValues = function () {
        if ($scope.radioGender == false) {
            
            $scope.howSidWomen = $scope.howSidMen;
            $scope.howSidWomenLeft = $scope.howSidMenLeft;
            $scope.gohowSidWomen($scope.howSidWomen, $scope.howSidWomenLeft)
     
            $scope.howwaistw = $scope.howwaist;
            $scope.howhipw = $scope.howhip;
            calculawaisttohipw($scope.howwaistw, $scope.howhipw);
            ...
            if (!$scope.radioMPW) {
                if ($scope.selectedAge.id == 0) {
                    $scope.numpwm1 = $scope.numnpmen1;
                    $scope.gonumpwm1($scope.numpwm1);
                }
                else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                    $scope.numpwm2 = $scope.numnpmen2;
                    $scope.gonumpwm2($scope.numpwm2);
                }
                else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                    $scope.numpwm3 = $scope.numnpmen3;
                    $scope.gonumpwm3($scope.numpwm3);
                }
                else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
                    $scope.numpwm4 = $scope.numnpmen4;
                    $scope.gonumpwm4($scope.numpwm4);
                }
                else if ($scope.selectedAge.id >= 7) {
                    $scope.numpwm5 = $scope.numnpmen5;
                    $scope.gonumpwm5($scope.numpwm5);
                }
            }
            else {
                if ($scope.selectedAge.id == 0) {
                    $scope.numnpwm1 = $scope.numnpmen1;
                    $scope.gonumnpwm1($scope.numnpwm1);
                }
                else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                    $scope.numnpwm2 = $scope.numnpmen2;
                    $scope.gonumnpwm2($scope.numnpwm2);
                }
                else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                    $scope.numnpwm3 = $scope.numnpmen3;
                    $scope.gonumnpwm3($scope.numnpwm3);
                }
                else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
                    $scope.numnpwm4 = $scope.numnpmen4;
                    $scope.gonumnpwm4($scope.numnpwm4);
                }
                else if ($scope.selectedAge.id >= 7) {
                    $scope.numnpwm5 = $scope.numnpmen5;
                    $scope.gonumnpwm5($scope.numnpwm5);
                }
            }

            if ($scope.selectedAge.id == 0) {
                $scope.numMBCWpwm1 = $scope.numMBCMpwm1;
                $scope.gonumMBCWpwm1($scope.numMBCWpwm1);
            }
            else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                $scope.numMBCWpwm2 = $scope.numMBCMpwm2;
                $scope.gonumMBCWpwm2($scope.numMBCWpwm2);
            }
            else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                $scope.numMBCWpwm3 = $scope.numMBCMpwm3;
                $scope.gonumMBCWpwm3($scope.numMBCWpwm3);
            }
            else if ($scope.selectedAge.id >= 5) {
                $scope.numMBCWpwm4 = $scope.numMBCMpwm4;
                $scope.gonumMBCWpwm4($scope.numMBCWpwm4);
            }
       

            if ($scope.selectedAge.id == 0) {
                $scope.numMBCOOWOpwm1 = $scope.numMBCOOWpwm1;
                $scope.gonumMBCOOWOpwm1($scope.numMBCOOWOpwm1);
            }
            else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                $scope.numMBCOOWOpwm2 = $scope.numMBCOOWpwm2;
                $scope.gonumMBCOOWOpwm2($scope.numMBCOOWOpwm2);
            }
            else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                $scope.numMBCOOWOpwm3 = $scope.numMBCOOWpwm3;
                $scope.gonumMBCOOWOpwm3($scope.numMBCOOWOpwm3);
            }
            else if ($scope.selectedAge.id >= 5) {
                $scope.numMBCOOWOpwm4 = $scope.numMBCOOWpwm4;
                $scope.gonumMBCOOWOpwm4($scope.numMBCOOWOpwm4);
            }
            ...
            $scope.howSidMen = $scope.howSidWomen;
            $scope.howSidMenLeft = $scope.howSidWomenLeft;
            $scope.gohowSidMen($scope.howSidMen, $scope.howSidMenLeft);

            $scope.howwaist = $scope.howwaistw;
            $scope.howhip = $scope.howhipw;
            calculawaisttohip($scope.howwaist, $scope.howhip);

            if ($scope.selectedAge.id == 0) {
                $scope.numnpmen1 = $scope.numnpwm1;
                $scope.gonumnpmen1($scope.numnpmen1);
            }
            else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                $scope.numnpmen2 = $scope.numnpwm2;
                $scope.gonumnpmen2($scope.numnpmen2);
            }
            else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                $scope.numnpmen3 = $scope.numnpwm3;
                $scope.gonumnpmen3($scope.numnpmen3);
            }
            else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
                $scope.numnpmen4 = $scope.numnpwm4;
                $scope.gonumnpmen4($scope.numnpmen4);
            }
            else if ($scope.selectedAge.id >= 7) {
                $scope.numnpmen5 = $scope.numnpwm5;
                $scope.gonumnpmen5($scope.numnpmen5);
            }

            if ($scope.selectedAge.id == 0) {
                $scope.numMBCMpwm1 = $scope.numMBCWpwm1;
                $scope.gonumMBCMpwm1($scope.numMBCMpwm1);
            }
            else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                $scope.numMBCMpwm2 = $scope.numMBCWpwm2;
                $scope.gonumMBCMpwm2($scope.numMBCMpwm2);
            }
            else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                $scope.numMBCMpwm3 = $scope.numMBCWpwm3;
                $scope.gonumMBCMpwm3($scope.numMBCMpwm3);
            }
            else if ($scope.selectedAge.id >= 5) {
                $scope.numMBCMpwm4 = $scope.numMBCWpwm4;
                $scope.gonumMBCMpwm4($scope.numMBCMpwm4);
            }

            if ($scope.selectedAge.id == 0) {
                $scope.numMBCOOWpwm1 = $scope.numMBCOOWOpwm1;
                $scope.gonumMBCOOWpwm1($scope.numMBCOOWpwm1);
            }
            else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                $scope.numMBCOOWpwm2 = $scope.numMBCOOWOpwm2;
                $scope.gonumMBCOOWpwm2($scope.numMBCOOWpwm2);
            }
            else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                $scope.numMBCOOWpwm3 = $scope.numMBCOOWOpwm3;
                $scope.gonumMBCOOWpwm3($scope.numMBCOOWpwm3);
            }
            else if ($scope.selectedAge.id >= 5) {
                $scope.numMBCOOWpwm4 = $scope.numMBCOOWOpwm4;
                $scope.gonumMBCOOWpwm4($scope.numMBCOOWpwm4);
            }
    ...
    var putValuesByAge = function (idAgeOld, idAgeNew) {
        var pushmodified = 0;
        var chestValue = 0;
        var cooperValue = 0;
        ...
        if ($scope.radioGender == false) {
            ...
            if (!$scope.radioMPW) {
                ...
                if (idAgeOld == 0) {
                    pushmodified = $scope.numpwm1;
                }
                else if (idAgeOld == 1 || idAgeOld == 2) {
                    pushmodified = $scope.numpwm2;
                }
                else if (idAgeOld == 3 || idAgeOld == 4) {
                    pushmodified = $scope.numpwm3;
                }
                else if (idAgeOld == 5 || idAgeOld == 6) {
                    pushmodified = $scope.numpwm4;
                }
                else if (idAgeOld >= 7) {
                    pushmodified = $scope.numpwm5;
                }

                if (idAgeNew == 0) {
                    $scope.gonumpwm1(pushmodified);
                }
                else if (idAgeNew == 1 || idAgeNew == 2) {
                    $scope.gonumpwm2(pushmodified);
                }
                else if (idAgeNew == 3 || idAgeNew == 4) {
                    $scope.gonumpwm3(pushmodified);
                }
                else if (idAgeNew == 5 || idAgeNew == 6) {
                    $scope.gonumpwm4(pushmodified);
                }
                else if (idAgeNew >= 7) {
                    $scope.gonumpwm5(pushmodified);
                }
                ...
                if (idAgeOld == 0) {
                    pushmodified = $scope.numnpwm1;
                }
                else if (idAgeOld == 1 || idAgeOld == 2) {
                    pushmodified = $scope.numnpwm2;
                }
                else if (idAgeOld == 3 || idAgeOld == 4) {
                    pushmodified = $scope.numnpwm3;
                }
                else if (idAgeOld == 5 || idAgeOld == 6) {
                    pushmodified = $scope.numnpwm4;
                }
                else if (idAgeOld >= 7) {
                    pushmodified = $scope.numnpwm5;
                }

                if (idAgeNew == 0) {
                    $scope.gonumnpwm1(pushmodified);
                }
                else if (idAgeNew == 1 || idAgeNew == 2) {
                    $scope.gonumnpwm2(pushmodified);
                }
                else if (idAgeNew == 3 || idAgeNew == 4) {
                    $scope.gonumnpwm3(pushmodified);
                }
                else if (idAgeNew == 5 || idAgeNew == 6) {
                    $scope.gonumnpwm4(pushmodified);
                }
                else if (idAgeNew >= 7) {
                    $scope.gonumnpwm5(pushmodified);
                }
            }

            if (idAgeOld == 0) {
                chestValue = $scope.numMBCWpwm1;
            }
            else if (idAgeOld == 1 || idAgeOld == 2) {
                chestValue = $scope.numMBCWpwm2;
            }
            else if (idAgeOld == 3 || idAgeOld == 4) {
                chestValue = $scope.numMBCWpwm3;
            }
            else if (idAgeOld >= 5) {
                chestValue = $scope.numMBCWpwm4;
            }
           
            if (idAgeNew == 0) {
                $scope.gonumMBCWpwm1(chestValue);
            }
            else if (idAgeNew == 1 || idAgeNew == 2) {
                $scope.gonumMBCWpwm2(chestValue);
            }
            else if (idAgeNew == 3 || idAgeNew == 4) {
                $scope.gonumMBCWpwm3(chestValue);
            }
            else if (idAgeNew >= 5) {
                $scope.gonumMBCWpwm4(chestValue);
            }

            if (idAgeOld == 0) {
                cooperValue = $scope.numMBCOOWOpwm1;
            }
            else if (idAgeOld == 1 || idAgeOld == 2) {
                cooperValue = $scope.numMBCOOWOpwm2;
            }
            else if (idAgeOld == 3 || idAgeOld == 4) {
                cooperValue = $scope.numMBCOOWOpwm3;
            }
            else if (idAgeOld >= 5) {
                cooperValue = $scope.numMBCOOWOpwm4;
            }

            if (idAgeNew == 0) {
                $scope.gonumMBCOOWOpwm1(cooperValue);
            }
            else if (idAgeNew == 1 || idAgeNew == 2) {
                $scope.gonumMBCOOWOpwm2(cooperValue);
            }
            else if (idAgeNew == 3 || idAgeNew == 4) {
                $scope.gonumMBCOOWOpwm3(cooperValue);
            }
            else if (idAgeNew >= 5) {
                $scope.gonumMBCOOWOpwm4(cooperValue);
            }
        }
        else {

            if (idAgeOld == 0) {
                pushmodified = $scope.numnpmen1;
            }
            else if (idAgeOld == 1 || idAgeOld == 2) {
                pushmodified = $scope.numnpmen2;
            }
            else if (idAgeOld == 3 || idAgeOld == 4) {
                pushmodified = $scope.numnpmen3;
            }
            else if (idAgeOld == 5 || idAgeOld == 6) {
                pushmodified = $scope.numnpmen4;
            }
            else if (idAgeOld >= 7) {
                pushmodified = $scope.numnpmen5;
            }


            if (idAgeNew == 0) {
                $scope.gonumnpmen1(pushmodified);
            }
            else if (idAgeNew == 1 || idAgeNew == 2) {
                $scope.gonumnpmen2(pushmodified);
            }
            else if (idAgeNew == 3 || idAgeNew == 4) {
                $scope.gonumnpmen3(pushmodified);
            }
            else if (idAgeNew == 5 || idAgeNew == 6) {
                $scope.gonumnpmen4(pushmodified);
            }
            else if (idAgeNew >= 7) {
                $scope.gonumnpmen5(pushmodified);
            }

            if (idAgeOld == 0) {
                chestValue = $scope.numMBCMpwm1;
            }
            else if (idAgeOld == 1 || idAgeOld == 2) {
                chestValue = $scope.numMBCMpwm2;
            }
            else if (idAgeOld == 3 || idAgeOld == 4) {
                chestValue = $scope.numMBCMpwm3;
            }
            else if (idAgeOld >= 5) {
                chestValue = $scope.numMBCMpwm4;
            }

            if (idAgeNew == 0) {
                $scope.gonumMBCMpwm1(chestValue);
            }
            else if (idAgeNew == 1 || idAgeNew == 2) {
                $scope.gonumMBCMpwm2(chestValue);
            }
            else if (idAgeNew == 3 || idAgeNew == 4) {
                $scope.gonumMBCMpwm3(chestValue);
            }
            else if (idAgeNew >= 5) {
                $scope.gonumMBCMpwm4(chestValue);
            }


            if (idAgeOld == 0) {
                cooperValue = $scope.numMBCOOWpwm1;
            }
            else if (idAgeOld == 1 || idAgeOld == 2) {
                cooperValue = $scope.numMBCOOWpwm2;
            }
            else if (idAgeOld == 3 || idAgeOld == 4) {
                cooperValue = $scope.numMBCOOWpwm3;
            }
            else if (idAgeOld >= 5) {
                cooperValue = $scope.numMBCOOWpwm4;
            }

            if (idAgeNew == 0) {
                $scope.gonumMBCOOWpwm1(cooperValue);
            }
            else if (idAgeNew == 1 || idAgeNew == 2) {
                $scope.gonumMBCOOWpwm2(cooperValue);
            }
            else if (idAgeNew == 3 || idAgeNew == 4) {
                $scope.gonumMBCOOWpwm3(cooperValue);
            }
            else if (idAgeNew >= 5) {
                $scope.gonumMBCOOWpwm4(cooperValue);
            }
    ...
    var putModifiedValues = function () {
        if ($rootScope.phoneDevice < 0 || flagreview) {
            $scope.disablegender1women = true;
            $scope.disablegender2women = true;
            $scope.disablegender3women = true;
            ...
            if (!$scope.radioMPW) {
                if ($scope.selectedAge.id == 0) {
                    $scope.disablegendermod1women = false;
                }
                else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                    $scope.disablegendermod2women = false;
                }
                else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                    $scope.disablegendermod3women = false;
                }
                else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
                    $scope.disablegendermod4women = false;
                }
                else if ($scope.selectedAge.id >= 7) {
                    $scope.disablegendermod5women = false;
                }
            }
            else {
                if ($scope.selectedAge.id == 0) {
                    $scope.disablegender1women = false;
                }
                else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                    $scope.disablegender2women = false;
                }
                else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                    $scope.disablegender3women = false;
                }
                else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
                    $scope.disablegender4women = false;
                }
                else if ($scope.selectedAge.id >= 7) {
                    $scope.disablegender5women = false;
                }
            }

        }
        
        switchValues($scope.radioMPW);
       
    }

    var switchValues = function (modified) {
        if (!modified) {
            if ($scope.selectedAge.id == 0) {
                $scope.numpwm1 = $scope.numnpwm1;
                $scope.gonumpwm1($scope.numpwm1);
            }
            else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                $scope.numpwm2 = $scope.numnpwm2;
                $scope.gonumpwm2($scope.numpwm2);
            }
            else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                $scope.numpwm3 = $scope.numnpwm3;
                $scope.gonumpwm3($scope.numpwm3);
            }
            else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
                $scope.numpwm4 = $scope.numnpwm4;
                $scope.gonumpwm4($scope.numpwm4);
            }
            else if ($scope.selectedAge.id >= 7) {
                $scope.numpwm5 = $scope.numnpwm5;
                $scope.gonumpwm5($scope.numpwm5);
            }
        }
        else {
            if ($scope.selectedAge.id == 0) {
                $scope.numnpwm1 = $scope.numpwm1;
                $scope.gonumnpwm1($scope.numnpwm1);
            }
            else if ($scope.selectedAge.id == 1 || $scope.selectedAge.id == 2) {
                $scope.numnpwm2 = $scope.numpwm2;
                $scope.gonumnpwm2($scope.numnpwm2);
            }
            else if ($scope.selectedAge.id == 3 || $scope.selectedAge.id == 4) {
                $scope.numnpwm3 = $scope.numpwm3;
                $scope.gonumnpwm3($scope.numnpwm3);
            }
            else if ($scope.selectedAge.id == 5 || $scope.selectedAge.id == 6) {
                $scope.numnpwm4 = $scope.numpwm4;
                $scope.gonumnpwm4($scope.numnpwm4);
            }
            else if ($scope.selectedAge.id >= 7) {
                $scope.numnpwm5 = $scope.numpwm5;
                $scope.gonumnpwm5($scope.numnpwm5);
            }
        }
