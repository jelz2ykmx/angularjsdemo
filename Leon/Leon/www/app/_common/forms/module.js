(function(){
    ...
    angular.module('SmartAdmin.Forms', ['angular-datepicker', 'ui.utils.masks', 'ngJustGage', 'chart.js']);


    app.factory('UserProviderFactory', function () {
        return {
            copy: function (email, userId, firtsName, lastName) {
                return angular.extend({ email: email, userId: userId, firtsName: firtsName, lastName: lastName }, this);
            }
        };
    ...
    app.factory('ChangePasswordFactory', function () {
        return {
            copy: function (userId, OldPassword, NewPassword, email) {
                return angular.extend({ userId: userId, OldPassword: OldPassword, NewPassword: NewPassword, email: email }, this);
            }
        };
    ...
    app.factory('queryQuestionFactory', function () {
        return {
            copy: function (id, email, firstName, lastName, status, datelocal, dashboard) {
                return angular.extend({ id: id, email: email, firstName: firstName, lastName: lastName, status: status, datelocal: datelocal, dashboard: dashboard }, this);
            }
        };
    ...
    app.factory('assementsLast20Factory', function () {
        return {
            copy: function (dateLocal, Name, Age, Score, Percentile, Health, Lifestyle, Biodata, Mobility, Fitness, Assessor, Location, idForm) {
                return angular.extend({
                    dateLocal: dateLocal, Name: Name, Age: Age, Score: Score, Percentile: Percentile, Health: Health, Lifestyle: Lifestyle,
                    Biodata: Biodata, Mobility: Mobility, Fitness: Fitness, Assessor: Assessor, Location: Location, idForm: idForm
                }, this);
            }
        };
    ...
    app.factory('assementsTopBottomFactory', function () {
        return {
            copy: function (Score, Age, Health, Lifestyle, Biodata, Mobility, Fitness, Assessor, idForm) {
                return angular.extend({
                    Score: Score, Age: Age, Health: Health, Lifestyle: Lifestyle,
                    Biodata: Biodata, Mobility: Mobility, Fitness: Fitness, Assessor: Assessor, idForm: idForm
                }, this);
            }
        };
    ...
    app.factory('validicAppsFactory', function () {
        return {
            copy: function (name, syncUrl, unsyncUrl, logoUrl, synced, mobile) {
                return angular.extend({
                    name: name, syncUrl: syncUrl, unsyncUrl: unsyncUrl, logoUrl: logoUrl, synced: synced, mobile: mobile
                }, this);
            }
        };
    ...
    /* Chart.js api: http://www.chartjs.org/docs/ */

    app.factory('chartBarOptions', function () {
        return {
            tooltips: {
                enabled: false
            },
    ...
    app.factory('chartBarColors', function () {
        return {
            allbars: "#16CCCA",
            onebar: "#FFA202"
        };
